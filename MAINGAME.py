...
class HealthBar():
    ...
    def draw(self, health):
        ...
        draw_text('Zombie (release.02.08.2023)', ver, WHITE, 5, 853)
...
def info_show():
        ...
        draw_text('In ZOMBIOO survive the zombie', LORE, WHITE, 680, 350)
...
while run:
    ...
    if start_game == False:
        ...
        draw_text('ARJUN VIJAYAN JASSIYA', JanKupczyk, WHITE, 905, 845)
        draw_text('VIJAY62704 (Released.01.08.2023)', ver, WHITE, 5, 845)
        ...
        if jk_button.draw(screen):
            MENUSELECT.play()
            webbrowser.open('https://github.com/Av22463')
        ...
        if info_button.draw(screen):
            MENUSELECT.play()
            webbrowser.open('https://github.com/Av22463/Zombioo/stargazers')
            webbrowser.open('https://Av22463.github.io/Zombioo/')
    else:
        draw_bg()
        world.draw()
